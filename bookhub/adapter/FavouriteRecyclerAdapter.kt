...
import com.sonelchndr.bookhub.R.id.llFavContent
import com.sonelchndr.bookhub.database.BookEntity
import com.squareup.picasso.Picasso
import kotlinx.android.synthetic.main.fragment_recycler_favourite_single_row.view.*
...
class FavouriteRecyclerAdapter(val context: Context,val bookList: List<BookEntity>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavouriteViewHolder {
        ...
        val view= LayoutInflater.from(parent.context)
            .inflate(R.layout.fragment_recycler_favourite_single_row,parent,false)
    ...
    class FavouriteViewHolder(view: View):RecyclerView.ViewHolder(view)
    {
        ...
        val llContent: LinearLayout =view.findViewById(llFavContent)
    }
